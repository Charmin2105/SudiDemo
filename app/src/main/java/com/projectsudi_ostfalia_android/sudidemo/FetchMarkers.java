...
public class FetchMarkers extends AsyncTask<String,Void,String> {

    private final static String mLogTag = "SudiDEMO FetchMarkers";
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            final String MARKER_BASE_URL =  "https://sudirest20181030020815.azurewebsites.net/api/marker/";


            Uri builtURI = Uri.parse(MARKER_BASE_URL);
